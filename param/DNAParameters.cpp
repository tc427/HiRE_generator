...
void DNAParameters::init()
{
	...
	angles = { {"R4", 0, "R1", 0, "A1", 0,  70, 130.0  },    // k=50 works
			   {"R4", 0, "R1", 0, "U1", 0,  70, 142.0  },
			   {"R4", 0, "R1", 0, "G1", 0,  70, 131.0  },
			   {"R4", 0, "R1", 0, "C1", 0,  70, 146.0  },
			   {"R1", 0, "A1", 0, "A2", 0, 120, 116.0  },
			   ...
			   {"O3", 0,  "P", 1,  "O", 1,  50, 101.0  },       // 8th, May 10
			   { "C", 0, "R4", 0, "R1", 0,  70, 130.0  },
			   {"R1", 0, "R4", 0,  "P", 1,  30,  85.0  },
	...
	diedrals = { {"R4", 0, "R1", 0, "G1", 0, "G2", 0, 1.0,  -120.0, 2  },       // -20
				 {"R4", 0, "R1", 0, "A1", 0, "A2", 0, 1.0,  -120.0, 2  },       // -20
		                 ...
		                 { "P", 1, "R4", 0, "R1", 0, "A1", 0,1.0,30.0, 1  },
		                 { "P", 1, "R4", 0, "R1", 0, "G1", 0,1.0,30.0, 1  },
		                 { "P", 1, "R4", 0, "R1", 0, "C1", 0,1.0,30.0, 1  },
		                 { "P", 1, "R4", 0, "R1", 0, "U1", 0,1.0,30.0, 1  },
                                 { "C", 0, "R4", 0,  "P", 1,  "O", 1,1.2,    5.0, 1  },       // 6.0 Feb 20 mod
