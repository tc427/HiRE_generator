...
void RNAParameters::init()
{
	...
	diedrals = { {"R4", 0, "R1", 0, "G1", 0, "G2", 0, 20.0,  -30.0, 1  },       // -20
			 	 {"R4", 0, "R1", 0, "A1", 0, "A2", 0, 20.0,  -30.0, 1  },       // -20
				 { "C", 0, "R4", 0,  "P", 1,  "O", 1,  6.0,   35.0, 1  },       // history coef: 75 -> 50 angle: 75 -> 25 -> 35
				 { "C", 0, "R4", 0, "R1", 0, "A1", 0, 10.0, -155.0, 1  },       // history coef: 50 -> 150
				 { "C", 0, "R4", 0, "R1", 0, "G1", 0, 10.0, -150.0, 1  },       // history coef: 50 -> 150
				 { "C", 0, "R4", 0, "R1", 0, "C1", 0, 10.0, -150.0, 1  },
				 { "C", 0, "R4", 0, "R1", 0, "U1", 0, 10.0, -145.0, 1  },
				 { "P", 0,  "O", 0,  "C", 0, "R4", 0, 15.0,   -2.0, 1  },       // history: coef: 50 -> 10
				 {"R4", 0,  "P", 1,  "O", 1,  "C", 1,  7.0,   80.0, 1  },		// val AMBER  history: 95 -> 85
				 { "O", 0,  "C", 0, "R4", 0,  "P", 1,  2.0, -100.0, 1  },		// -105 history coef: 25 -> 2
				 { "O", 0,  "C", 0, "R4", 0, "R1", 0,  2.0,   90.0, 2  },
//				 { "C", 0, "R1", 0, "R4", 0,  "P", 1,  0.0,   85.0, 1  },       // history coef: 50 -> 200 angle: 70 -> 60
