...
void RNAParameters::init()
{
	...
	angles = { {"R4", 0, "R1", 0, "A1", 0,  70, 123.6  },    // k=50 works
        ...
        diedrals = { {"R4", 0, "R1", 0, "G1", 0, "G2", 0, 1.0,  120.0, 2  },       // -20
		           {"R4", 0, "R1", 0, "A1", 0, "A2", 0,1.0,  120.0, 2  },
		           ...
		           { "C", 0, "R4", 0, "R1", 0, "A1", 0,1.0,-150.0,  1  },
		           { "C", 0, "R4", 0, "R1", 0, "A1", 0,0.2, 150.0,  1  },
		           { "C", 0, "R4", 0, "R1", 0, "G1", 0,1.0,-150.0,  1  },
		           { "C", 0, "R4", 0, "R1", 0, "C1", 0,1.0,-150.0,  1  },
		           { "C", 0, "R4", 0, "R1", 0, "C1", 0,0.2, 150.0,  1  },
		           { "C", 0, "R4", 0, "R1", 0, "U1", 0,1.0,-150.0,  1  },
		           { "C", 0, "R4", 0, "R1", 0, "U1", 0,0.2, 150.0,  1  },
		           { "P", 1, "R4", 0, "R1", 0, "A1", 0,1.0, 100.0, 1  },
		           { "P", 1, "R4", 0, "R1", 0, "G1", 0,1.0, 100.0, 1  },
		           { "P", 1, "R4", 0, "R1", 0, "C1", 0,1.0, 100.0, 1  },
		           { "P", 1, "R4", 0, "R1", 0, "U1", 0,1.0, 100.0, 1  },
		           { "C", 0, "R4", 0,  "P", 1,  "O", 1,1.2,   20.0, 1  },       // 6.0 Feb 20 mod
		           {"R1", 0, "R4", 0,  "P", 1,  "O", 1,1.2,  160.0, 1  },
		           { "O", 0,  "C", 0, "R4", 0,  "P", 1,1.0,   90.0, 3  },    // 2.0
